...
\mintinline{c++}{zeta_reduced_bispectrum_time_series}
\mintinline{c++}{zeta_reduced_bispectrum_wavenumber_series}    
represent ratios of 2- and 3-point correlation functions.
...
We also use the following abbreviations for tasks: \\
