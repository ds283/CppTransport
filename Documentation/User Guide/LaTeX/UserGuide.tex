...
\begin{itemize}
    ...
    \mintinline{c++}{set_astar_normalization(double astar)} \\
...
\begin{minted}[bgcolor=blue!10]{text}
	...
	Created: 2016-May-13 10:09:09      Last update: 2016-May-13 10:13:46  
	Runtime version: 2016.1            
	
	Derived product        Type     Matches tags  Filename        
	dquad.product.bg_plot  2d plot  --            background.pdf  
	
	Content group                   Created           Last update
	20160513T101334    2016-May-13 10:13:34  2016-May-13 10:13:46	
\end{minted}
...
\begin{minted}[bgcolor=blue!10]{text}
	$ ./dquad -r test-output/ --info 20160513T101334
	20160513T101334 -- derived content
	Created: 2016-May-13 10:13:34      Last update: 2016-May-13 10:13:46  
	Runtime version: 2016.1            Task: dquad.output.zeta            
	Locked: No                         Tags: --                           
	
	Summary of content groups used
	Content group    Task           Type                    Last update
	20160513T100911  dquad.threepf  integration    2016-May-13 10:13:34
\end{minted}
...
Some of these are common to both tables and products. They are:
\begin{itemize}
	\item \mintinline{c++}{bool get_log_x()} \\
	\mintinline{c++}{set_log_y(bool f)} \\
	Determine whether logarithmic $x$-axis values are used
	
	This setting applies to both tables and plots.
\end{itemize}
...
to select which indices should be plotted.

Constructing a selector requires specifying a template argument which fixes the
number of indices. Also, the constructor accepts a single argument giving the number
of fields.
...
As explained above, index selectors enable all components by default.
