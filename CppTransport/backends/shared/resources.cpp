...
namespace macro_packages
  {
    ...
    const std::vector<simple_rule> resources::get_pre_rules()
      {
        ...
        const std::vector<std::string> names =
          { "RESOURCE_PARAMETERS",            "RESOURCE_COORDINATES",
            "RESORUCE_DV",                    "RESOURCE_DDV",                     "RESOURCE_DDDV",
    ...
    std::string resources::set_params(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[PARAMETERS_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::set_coordinates(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[COORDINATES_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::set_dV(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[DV_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::set_ddV(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[DDV_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::set_dddV(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[DDDV_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::set_connexion(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[CONNEXION_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::set_Riemann(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().assign_parameters(args[RIEMANN_KERNEL_ARGUMENT]);
        return std::string();
      }
    ...
    std::string resources::release(const macro_argument_list& args)
      {
        this->u_factory.get_resource_manager().release();
        return std::string();
      }
