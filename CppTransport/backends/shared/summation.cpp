...
namespace macro_packages
  {
    ...
    const std::vector<macro_packages::index_rule> summation::get_index_rules()
      {
        ...
        const std::vector<enum index_class> ranges =
          { index_class::full, index_class::field_only, index_class::parameter,
            index_class::full, index_class::field_only, index_class::parameter
          };
    ...
    std::string summation::null(const macro_argument_list& args, const assignment_list& indices, void* state)
      {
        return("");
      }
