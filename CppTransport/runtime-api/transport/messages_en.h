...
#define __CPP_TRANSPORT_DATACTR_AGGREGATE_B     "for batching into principal database (sqlite3 code="
...
#define __CPP_TRANSPORT_DATACTR_BACKGATTACH   "Data container error: Failed to attach temporary container for backg transfer (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_BACKGREAD     "Data container error: Failed to read backg values from temporary container (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_BACKGWRITE    "Data container error: Failed to aggregate backg values into principal container (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_BACKGXFM      "Data container error: Failed to aggregate gauge-xfm values into principal container (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_BACKGDETACH   "Data container error: Failed to detach temporary container following backg trnsfer (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_TWOPFATTACH   "Data container error: Failed to attach temporary container for twopf transfer (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_TWOPFCOPY     "Data container error: Failed to copy twopf values from temporary container (sqlite3 code="
#define __CPP_TRANSPORT_DATACTR_TWOPFDETACH   "Data container error: Failed to detach temporary container following twopf transfer (sqlite3 code="
