...
#define __CPP_TRANSPORT_TIMES_RANGE           "Internal error: Out of range when accessing 'task' object"
...
#define __CPP_TRANSPORT_ICS_MISMATCH          "Internal error: Mismatched number of values when constructing 'initial_conditions' object"
#define __CPP_TRANSPORT_PARAMS_MISMATCH       "Internal error: Mismatched number of values when constructing 'parameters' object"
...
#define __CPP_TRANSPORT_REPO_MODEL_EXISTS     "Repository error: Attempt to insert duplicate model specification"
#define __CPP_TRANSPORT_REPO_INTGRTN_EXISTS   "Repository error: Attempt to insert duplicate integration specification"
#define __CPP_TRANSPORT_REPO_INSERT_ERROR     "Repository error: Error while inserting XML document into repository (DBXML code="
#define __CPP_TRANSPORT_REPO_QUERY_ERROR      "Repository error: Error while querying XML document from repository (DBXML code="
...
#define __CPP_TRANSPORT_BADLY_FORMED_INTGRTN  "Repository error: Badly formed XML for 'integration' document"
#define __CPP_TRANSPORT_BADLY_FORMED_PACKAGE  "Repository error: Badly formed XML for 'package' document"
#define __CPP_TRANSPORT_BADLY_FORMED_MODEL    "Repository error: Badly formed XML for 'model' group"
...
#define __CPP_TRANSPORT_DATACTR_TEMPCTR_FAIL_B  "(sqlite3 code="
