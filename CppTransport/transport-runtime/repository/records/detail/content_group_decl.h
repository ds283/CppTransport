...
namespace transport
  {
    ...
    inline content_group_specifier make_zeta_twopf_content_specifier(bool spectral_data)
      {
        return content_group_specifier{false, false, spectral_data};
      }


    inline content_group_specifier make_zeta_threepf_content_specifier()
      {
        // no specific requirements, since 2pf and 3pf will always be available
        // in content generated by an integration task
        return content_group_specifier{false, false, false};
      }


    inline content_group_specifier make_fNL_content_specifier()
      {
        // fNL tasks expect reduced bispectrum and zeta 2pf to be present
        precomputed_products products{true, false, false, true,
                                      false, false, false, false};
        return content_group_specifier{products};
      }
