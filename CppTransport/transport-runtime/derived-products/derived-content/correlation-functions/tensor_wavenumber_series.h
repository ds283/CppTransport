    ...
    namespace derived_data
	    {
          ...
          public:
            ...
            //! get type
            derived_line_type get_line_type() const override { return derived_line_type::tensor_twopf_wavenumber; }
          ...
          public:
		        ...
		        std::string get_non_LaTeX_label(unsigned int m, unsigned int n, double t) const;
				    ...
				    //! self-replicate
				    tensor_twopf_wavenumber_series<number>* clone() const override { return new tensor_twopf_wavenumber_series<number>(static_cast<const tensor_twopf_wavenumber_series<number>&>(*this)); }
        ...
        tensor_twopf_wavenumber_series<number>::tensor_twopf_wavenumber_series
                        ...
                        if(this->active_indices.is_on(index_set))
                          {
                            ...
                            lines.emplace_back(group, this->x_type, value_type::spectral_index, w_axis, line_data,
                                               this->get_LaTeX_label(m,n,t_value.t), this->get_non_LaTeX_label(m,n,t_value.t), messages, true);
                          }
                      }
                  }
              }
