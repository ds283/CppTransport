                        ...
                        if(this->active_indices.is_on(index_set))
                          {
                            ...
                            time_data_line_factory(*this, lines, group, this->x_type, value_type::dimensionless, t_axis,
                                                   line_data, this->get_LaTeX_label(m,n,k_config),
                                                   this->get_non_LaTeX_label(m,n,k_config), messages);
                          }
                      }
                  }
              }
