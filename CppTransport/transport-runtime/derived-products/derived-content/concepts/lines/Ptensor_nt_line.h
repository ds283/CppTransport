...
#ifndef CPPTRANSPORT_PTENSOR_NT_LINE_H
#define CPPTRANSPORT_PTENSOR_NT_LINE_H
...
namespace transport
    ...
    namespace derived_data
        ...
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_PTENSOR_NT_LINE_ROOT          = "Ptensor-line-settings";
		    ...
		    //! eg. wavenumber_series<> and Ptensor_nt_line<>
		    template <typename number>
		    class Ptensor_nt_line: public virtual derived_line<number>
			    {
		      ...
		      public:
				    ...
				    Ptensor_nt_line(const twopf_db_task<number>& tk);

				    //! Deserialization constructor
				    Ptensor_nt_line(Json::Value& reader, task_finder<number>& finder);

				    //! destructor is default
				    virtual ~Ptensor_nt_line() = default;
		    ...
		    template <typename number>
		    Ptensor_nt_line<number>::Ptensor_nt_line(const twopf_db_task<number>& tk)
		    ...
		    template <typename number>
		    Ptensor_nt_line<number>::Ptensor_nt_line(Json::Value& reader, task_finder<number>& finder)
		    ...
		    template <typename number>
		    std::string Ptensor_nt_line<number>::make_LaTeX_label() const
			    {
		        std::ostringstream label;
		        label << std::setprecision(this->precision);

            label << CPPTRANSPORT_LATEX_PTENSOR_NT_SYMBOL;
        ...
        template <typename number>
        std::string Ptensor_nt_line<number>::make_non_LaTeX_label() const
	        {
            std::ostringstream label;
            label << std::setprecision(this->precision);

            label << CPPTRANSPORT_NONLATEX_PTENSOR_NT_SYMBOL;
		    ...
		    template <typename number>
		    void Ptensor_nt_line<number>::serialize(Json::Value& writer) const
			    {
			    }


		    template <typename number>
		    void Ptensor_nt_line<number>::write(std::ostream& out)
			    {
				    out << " " << CPPTRANSPORT_PRODUCT_WAVENUMBER_SERIES_LABEL_PTENSOR_NT << '\n';
			    }

	    }
	}

#endif //CPPTRANSPORT_PTENSOR_NT_LINE_H
