		    ...
		    namespace
		        ...
		        namespace derived_line_helper
		            ...
		            std::unique_ptr< derived_line<number> > deserialize(Json::Value& reader, task_finder<number> finder)
		                ...
		                else if(type == CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_DLOGK_TWOPF_TIME_SERIES)                   return std::make_unique< dlogk_twopf_time_series<number> >(reader, finder);
                    ...
                    else if(type == CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_TENSOR_TWOPF_DLOGK_TIME_SERIES)            return std::make_unique< tensor_dlogk_twopf_time_series<number> >(reader, finder);
                    ...
                    else if(type == CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_DLOGK_TWOPF_WAVENUMBER_SERIES)             return std::make_unique< dlogk_twopf_wavenumber_series<number> >(reader, finder);
                    ...
                    else if(type == CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_TENSOR_TWOPF_DLOGK_WAVENUMBER_SERIES)      return std::make_unique< tensor_dlogk_twopf_wavenumber_series<number> >(reader, finder);
