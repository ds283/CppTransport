...
namespace transport
	{
        ...
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_DLOGK_TWOPF_TIME_SERIES                   = "dlogk-twopf-time-series";
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_TENSOR_TWOPF_TIME_SERIES                  = "tensor-twopf-time-series";
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_TENSOR_TWOPF_DLOGK_TIME_SERIES            = "tensor-dlogk-twopf-time-series";
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_ZETA_TWOPF_TIME_SERIES                    = "zeta-twopf-time-series";
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_ZETA_TWOPF_NS_TIME_SERIES                 = "zeta-twopf-ns-time-series";
        ...
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_DLOGK_TWOPF_WAVENUMBER_SERIES             = "dlogk-twopf-k-series";
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_TENSOR_TWOPF_WAVENUMBER_SERIES            = "tensor-twopf-k-series";
        constexpr auto CPPTRANSPORT_NODE_PRODUCT_DERIVED_LINE_TENSOR_TWOPF_DLOGK_WAVENUMBER_SERIES      = "tensor-dlogk-twopf-k-series";
