...
constexpr auto CPPTRANSPORT_REPO_TOOLKIT_VERTEX_NOT_FOUND           = "Could not find vertex";
constexpr auto CPPTRANSPORT_REPO_TOOLKIT_D_NOT_INITIALIZED          = "Attempt to use distance matrix before initialization";
constexpr auto CPPTRANSPORT_REPO_TOOLKIT_D_OUT_OF_RANGE             = "Attempt to access out-of-range distance matrix element";
