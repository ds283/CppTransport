...
namespace transport
  {
    ...
    constexpr auto CPPTRANSPORT_TASK_CONTENT_GROUP_BAD_TASK_TYPE = "Bad task type for content_group_specifier object";
    constexpr auto CPPTRANSPORT_TASK_CONTENT_GROUP_BAD_MERGE = "Attempt to merge two content_group_specifier objects with incompatible types";
