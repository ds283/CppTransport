...
constexpr auto CPPTRANSPORT_LATEX_DIMENSIONLESS_PZETA          = R"(\mathcal{P}_{\zeta})";
constexpr auto CPPTRANSPORT_NONLATEX_DIMENSIONLESS_PZETA       = "cal(P)_zeta";
constexpr auto CPPTRANSPORT_LATEX_DIMENSIONLESS_TWOPF          = R"(\Delta)";
constexpr auto CPPTRANSPORT_NONLATEX_DIMENSIONLESS_TWOPF       = "Delta";
