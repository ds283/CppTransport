...
constexpr auto CPPTRANSPORT_REPORT_PAYLOAD_HAS_SPECTRAL            = "Spectral data";
...
constexpr auto CPPTRANSPORT_REPORT_PAYLOAD_HAS_ZETA_TWOPF_SPECTRAL = "zeta twopf spectral index";
