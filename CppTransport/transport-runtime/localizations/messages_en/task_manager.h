...
#define CPPTRANSPORT_SLAVE_NOT_INTEGRATION_CONTENT     "Expected datapipe to be attached to an integration payload"
#define CPPTRANSPORT_SLAVE_NOT_POSTINTEGRATION_CONTENT "Expected datapipe to be attached to a postintegration payload"
