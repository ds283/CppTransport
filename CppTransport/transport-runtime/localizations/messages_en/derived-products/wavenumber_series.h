...
#define CPPTRANSPORT_PRODUCT_WAVENUMBER_SERIES_NULL_DATAPIPE            "Null datapipe in wavenumber_series or derived class"
#define CPPTRANSPORT_PRODUCT_WAVENUMBER_SERIES_NULL_MODEL               "Null model in wavenumber_series or derived class"
#define CPPTRANSPORT_PRODUCT_WAVENUMBER_SERIES_NULL_READER              "Null serialization reader in wavenumber_series or derived class"
...
#define CPPTRANSPORT_PRODUCT_WAVENUMBER_SERIES_UNKNOWN_OPPOS            "Unknown operator position for three-point function shift"
