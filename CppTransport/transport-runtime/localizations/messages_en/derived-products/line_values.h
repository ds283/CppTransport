...
#define CPPTRANSPORT_VALUE_LATEX_FIELD                    "\\textrm{field value}"
#define CPPTRANSPORT_VALUE_LATEX_MOMENTUM                 "\\textrm{momentum value}"
#define CPPTRANSPORT_VALUE_LATEX_CORRELATION_FUNCTION     "\\textrm{correlation function}"
#define CPPTRANSPORT_VALUE_LATEX_FNL                      "$f_{\\mathrm{NL}}$"
#define CPPTRANSPORT_VALUE_LATEX_R                        "\\textrm{tensor-to-scalar ratio}"
#define CPPTRANSPORT_VALUE_LATEX_SPECTRAL_INDEX           "\\textrm{spectral index}"
#define CPPTRANSPORT_VALUE_LATEX_SECONDS                  "\\textrm{seconds}"
#define CPPTRANSPORT_VALUE_LATEX_STEPS                    "\\textrm{steps}"
