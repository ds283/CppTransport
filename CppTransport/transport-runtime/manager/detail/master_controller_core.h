...
namespace transport
  {
    ...
    bool master_controller_impl::ContentGroupFilterPredicate<number>::match_integration_content_group
      (const std::string& name) const
      {
        ...
        // test whether payload matches specifier
            ...
            case postintegration_task_type::twopf:
              {
                ...
                requirement_type elt{task.get_name(),
            ...
            case postintegration_task_type::threepf:
              {
                ...
                requirement_type elt{task.get_name(), {false, false, false}};
            ...
            case postintegration_task_type::fNL:
              {
                ...
                requirement_type elt{task.get_name(), content_group_specifier{products}};
