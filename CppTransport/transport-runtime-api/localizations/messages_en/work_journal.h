...
#define __CPP_TRANSPORT_JOURNAL_DATABASE_TOO_FEW         "Too few items in journal: Missing end-database event"
...
#define __CPP_TRANSPORT_JOURNAL_DATABASE_END_MISSING     "Expected end-database event following begin-database"
