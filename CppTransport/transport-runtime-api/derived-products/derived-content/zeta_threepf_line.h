		...
		namespace derived_data
		    ...
		    class zeta_threepf_line: public virtual derived_line<number>
		      ...
		      public:
				    ...
				    zeta_threepf_line(const threepf_task<number>& tk, model<number>* m, index_selector<3>& sel, filter::threepf_kconfig_filter& kfilter);
		    ...
		    template <typename number>
		    zeta_threepf_line<number>::zeta_threepf_line(const threepf_task<number>& tk, model<number>* m,
		                                                 filter::threepf_kconfig_filter& kfilter)
		      : use_kt_label(true), use_alpha_label(false), use_beta_label(false)
				...
				template <typename number>
				std::string zeta_threepf_line<number>::make_LaTeX_label(void)
					{
				...
				template <typename number>
				std::string zeta_threepf_line<number>::make_non_LaTeX_label(void)
					{
