		...
		namespace derived_data
		    ...
		    class r_time_series: public time_series<number>, public r_line<number>
		      ...
		      public:
				    ...
				    r_time_series(serialization_reader* reader, typename repository<number>::task_finder& finder);
		      ...
		      public:
				...
				r_time_series<number>::r_time_series(const twopf_list_task<number>& tk, filter::time_filter tfilter,
					...
					: derived_line<number>(tk, derived_line<number>::time_series, derived_line<number>::r, prec),
				...
				// We have to call it ourselves
				template <typename number>
				r_time_series<number>::r_time_series(serialization_reader* reader, typename repository<number>::task_finder& finder)
		    ...
		    void r_time_series<number>::derive_lines(typename data_manager<number>::datapipe& pipe, std::list<data_line<number> >& lines,
		        ...
		        this->attach(pipe, tags);
				    ...
				    for(unsigned int i = 0; i < this->kconfig_sample_sns.size(); i++)
				        ...
				        data_line<number> line = data_line<number>(data_line<number>::time_series, data_line<number>::r,
