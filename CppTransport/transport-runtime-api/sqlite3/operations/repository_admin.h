...
#define CPPTRANSPORT_SQLITE_RESERVED_CONTENT_NAMES_TABLE "reserved_content"
        ...
        std::string reserve_content_name(transaction_manager& mgr, sqlite3* db, const std::string& posix_time_string, const std::string& suffix)
          {
            ...
            std::stringstream store_stmt;
            store_stmt << "INSERT INTO " << CPPTRANSPORT_SQLITE_RESERVED_CONTENT_NAMES_TABLE << " VALUES (@name, @posix_time)";
