        ...
        class comparator
          ...
          public:
            ...
            bool operator()(const element<number>& a, const element<number>& b)
                ...
                if(t_a == this->order_map.end() || t_b == this->order_map.end()) throw transport::runtime_exception(transport::runtime_exception::RUNTIME_ERROR, CPPTRANSPORT_NAMED_LIST_FAIL);
