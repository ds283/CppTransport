...
namespace transport
    ...
    class json_serialization_stack
      ...
      protected:
        ...
        class root_node: public basic_node
          ...
          public:
            ...
            virtual long int      get_long_int() const = 0;
        ...
        class value_element: public basic_value_element
          ...
          public:
            ...
            long int      get_long_int()      const override { return(boost::lexical_cast<long int>(this->value)); }
          ...
          protected:
            ...
            std::string to_string(const long int& v) const;
      ...
      public:
        ...
        void write_value(const std::string& name, long int value, bool is_insert=false);
        ...
        bool read_value(const std::string& name, long int& val);
    ...
    template <typename T>
    std::string json_serialization_stack::value_element<T>::to_string(const long int& v) const
      {
        return(boost::lexical_cast<std::string>(v));
      }
    ...
    void json_serialization_stack::write_value(const std::string& name, long int value, bool is_insert)
      {
        value_element<long int>* ele = new value_element<long int>(name, value);
...
#ifdef __CPP_TRANSPORT_JSON_DEBUG
        std::cerr << "JSON: Wrote long int value '" << name << "' = " << value << std::endl;
        #endif
      }
    ...
    bool json_serialization_stack::read_value(const std::string& name, long int& val)
      {
        bool rval = false;
        ...
        if((rval = n->pull_content(value, name, ele)))
          {
            ...
            basic_value_element* value = dynamic_cast< basic_value_element* >(ele);
            if(value == nullptr) throw runtime_exception(runtime_exception::SERIALIZATION_ERROR, __CPP_TRANSPORT_SERIAL_TYPEDETECT_FAIL);
            val = value->get_long_int();

#ifdef __CPP_TRANSPORT_JSON_DEBUG
            std::cerr << "JSON: read long int value '" << name << "' = " << val << std::endl;
		        #endif
          }
