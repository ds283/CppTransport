...
namespace transport
  {
    ...
    class threepf_kconfig_database: public serializable
      ...
      public:
        ...
        class generic_record_iterator: public std::iterator< std::bidirectional_iterator_tag, threepf_kconfig_record >
          {

            //! set up an alias for a reference to each element.
            //! there are const- and non-const-versions
            typedef typename std::conditional< is_const_iterator, const threepf_kconfig_record&, threepf_kconfig_record& >::type record_reference_type;
      ...
      public:
        ...
        template <bool is_const_iterator=true>
        class generic_config_iterator: public std::iterator< std::bidirectional_iterator_tag, threepf_kconfig >
          {

            //! set up an alias for a reference to each element.
            //! there are const- and non-const-versions
            typedef typename std::conditional< is_const_iterator, const threepf_kconfig&, threepf_kconfig& >::type config_reference_type;
