...
#ifndef CPPTRANSPORT_OUTPUT_GROUP_METADATA_IMPL_H
#define CPPTRANSPORT_OUTPUT_GROUP_METADATA_IMPL_H
...
namespace transport
  {
    ...
    constexpr auto CPPTRANSPORT_NODE_TIMINGDATA_MIN_MEAN_INT_TIME = "min-mean-integration-time";
    constexpr auto CPPTRANSPORT_NODE_TIMINGDATA_MAX_MEAN_INT_TIME = "max-mean-integration-time";
    ...
    constexpr auto CPPTRANSPORT_NODE_TIMINGDATA_MIN_MEAN_BATCH_TIME = "min-mean-batching-time";
    constexpr auto CPPTRANSPORT_NODE_TIMINGDATA_MAX_MEAN_BATCH_TIME = "max-mean-batching-time";
...
#endif //CPPTRANSPORT_OUTPUT_GROUP_METADATA_IMPL_H
