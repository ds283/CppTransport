...
const double Lambda   = pow(g, 1.0/4.0) * pow(25.0/(2*M_PI), 1.0/2.0);
...
int main(int argc, char* argv[])
  {
    ...
    std::shared_ptr< transport::new_axion_basic<double> > model = mgr->create_model< transport::new_axion_basic<double> >();
...
//    transport::aggregation_range<double> betas = betas_lo + betas_mid + betas_hi + betas_equi;
    ...
    transport::zeta_threepf_task<double> ztk3("new-axion.threepf-1.zeta", tk3);
    ...
    transport::derived_data::time_series_plot<double> tk3_twopf_plot("new-axion.threepf-1.twopf-time", "twopf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_SR_objects_plot("new-axion.threepf-1.SR_objects", "SR_objects.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_Hubble_plot("new-axion.threepf-1.Hubble", "Hubble.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_u2_plot("new-axion.threepf-1.u2", "u2.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_u3_plot("new-axion.threepf-1.u3", "u3.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_zeta_twopf("new-axion.threepf-1.zeta-twopf", "zeta-twopf-time.pdf");
...
//    tk3_redbsp.set_abs_y(false);
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_plot("new-axion.threepf-1.zeta-2spec", "zeta-2spec.pdf");
    ...
    transport::derived_data::wavenumber_series_table<double> tk3_zeta_2spec_table("new-axion.threepf-1.zeta-2spec.table", "zeta-2spec-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_beta_plot("new-axion.threepf-1.redbsp-beta", "redbsp-beta.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_sqk3_plot("new-axion.threepf-1.redbsp-sqk3", "redbsp-sqk3.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_sqk3_index_plot("new-axion.threepf-1.redbsp-sqk3-index", "redbsp-sqk3-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_spec_index_plot("new-axion.threepf-1.redbsp-spec-index", "redbsp-spec-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_index_plot("new-axion.threepf-1.zeta-2spec-index", "zeta-2spec-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_cost_plot("new-axion.threepf-1.sqk3-cost", "sqk3-cost.pdf");
    ...
    std::cout << "new-axion.threepf-1 output task:" << '\n' << threepf_output << '\n';
