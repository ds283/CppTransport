...
//    transport::aggregation_range<double> betas(betas_lo, betas_hi);
    ...
    transport::derived_data::time_series_plot<double> tk3_zeta_sq("inflection.threepf-1.zeta-sq", "zeta-sq.pdf");
    tk3_zeta_sq.add_line(tk3_zeta_sq_group);
    tk3_zeta_sq.set_title_text("3pf of $\\zeta$ near squeezed configurations");

		// set up a table too
    transport::derived_data::time_series_table<double> tk3_zeta_sq_table("inflection.threepf-1.zeta-sq.table", "zeta-sq-table.txt");
    ...
    transport::derived_data::time_series_plot<double> tk3_redbsp("inflection.threepf-1.redbsp-sq", "redbsp-sq.pdf");
    ...
    transport::derived_data::time_series_table<double> tk3_redbsp_table = transport::derived_data::time_series_table<double>("inflection.threepf-1.redbsp-sq.table", "redbsp-sq-table.txt");
