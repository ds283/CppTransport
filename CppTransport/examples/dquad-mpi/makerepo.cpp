...
int main(int argc, char* argv[])
  {
    ...
    transport::threepf_cubic_task<double> tk3 = transport::threepf_cubic_task<double>("dquad.threepf-1", ics, times, ks, TimeStoragePolicy(), ThreepfStoragePolicy());

    std::cout << tk3;

    // construct a twopf task
    transport::twopf_task<double> tk2 = transport::twopf_task<double>("dquad.twopf-1", ics, times, ks);
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_threepf_equi_spec = transport::derived_data::wavenumber_series_plot<double>("dquad.threepf-1.threepf-equi-spec", "threepf-equi-spec.pdf");
    ...
    transport::derived_data::wavenumber_series_table<double> tk3_threepf_equi_spec_tab = transport::derived_data::wavenumber_series_table<double>("dquad.threepf-1.threepf-equi-spec-tab", "threepf-equi-spec-tab.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_plot = transport::derived_data::wavenumber_series_plot<double>("dquad.threepf-1.zeta-2pec", "zeta-2spec.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_3equspec_plot = transport::derived_data::wavenumber_series_plot<double>("dquad.threepf-1.zeta-3equspec", "zeta-3equspec.pdf");
