...
int main(int argc, char* argv[])
  {
    ...
    transport::threepf_cubic_task<double> tk3 = transport::threepf_cubic_task<double>("dquad.threepf-1", ics, times, ks, model->kconfig_kstar_factory(), TimeStoragePolicy());
