...
#include "heavy_hilltop_basic_unrolled.h"
...
const double V0        = 3.0 * pow(1e-7 * M_Planck * M_Planck, 2.0);
const double eta_phi   = -0.02;
const double eta_sigma = -0.25;

const double phi_init   = 1e-1 * M_Planck;
const double sigma_init = 1e-6 * M_Planck;
...
int main(int argc, char* argv[])
  {
    ...
    std::shared_ptr< transport::heavy_hilltop_basic<double> > model = mgr->create_model< transport::heavy_hilltop_basic<double> >();

    // set up parameter choices
    const std::vector<double>     init_params = { V0, eta_phi, eta_sigma };
    ...
    transport::initial_conditions<double> ics("hilltop-1", model, params, init_values, Ninit, Ncross, Npre);
...
//    transport::aggregation_range<double> betas(betas_lo, betas_hi);
    ...
    transport::threepf_fls_task<double> tk3("hilltop.threepf-1", ics, times, kts, alphas, betas, ThreepfStoragePolicy(), false);
    ...
    transport::zeta_threepf_task<double> ztk3("hilltop.threepf-1.zeta", tk3);
    ...
    transport::derived_data::time_series_plot<double> tk3_twopf_plot("hilltop.threepf-1.twopf-time", "twopf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_threepf_plot("hilltop.threepf-1.threepf-time", "threepf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_SR_objects_plot("hilltop.threepf-1.SR_objects", "SR_objects.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_Hubble_plot("hilltop.threepf-1.Hubble", "Hubble.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_u2_plot("hilltop.threepf-1.u2", "u2.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_u3_plot("hilltop.threepf-1.u3", "u3.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_zeta_twopf("hilltop.threepf-1.zeta-twopf", "zeta-twopf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_zeta_sq("hilltop.threepf-1.zeta-sq", "zeta-sq.pdf");
    tk3_zeta_sq.add_line(tk3_zeta_sq_group);
    tk3_zeta_sq.set_title_text("3pf of $\\zeta$ near squeezed configurations");

		// set up a table too
    transport::derived_data::time_series_table<double> tk3_zeta_sq_table("hilltop.threepf-1.zeta-sq.table", "zeta-sq-table.txt");
    ...
    transport::derived_data::time_series_plot<double> tk3_redbsp("hilltop.threepf-1.redbsp-sq", "redbsp-sq.pdf");
    ...
    transport::derived_data::time_series_table<double> tk3_redbsp_table = transport::derived_data::time_series_table<double>("hilltop.threepf-1.redbsp-sq.table", "redbsp-sq-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_plot("hilltop.threepf-1.zeta-2spec", "zeta-2spec.pdf");
    ...
    transport::derived_data::wavenumber_series_table<double> tk3_zeta_2spec_table("hilltop.threepf-1.zeta-2spec.table", "zeta-2spec-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_spec_plot("hilltop.threepf-1.redbsp-spec", "redbsp-spec.pdf");
    ...
    transport::derived_data::wavenumber_series_table<double> tk3_redbsp_spec_table("hilltop.threepf-1.redbsp-spec-table", "redbsp-spec-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_beta_plot("hilltop.threepf-1.redbsp-beta", "redbsp-beta.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_sqk3_plot("hilltop.threepf-1.redbsp-sqk3", "redbsp-sqk3.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_sqk3_index_plot("hilltop.threepf-1.redbsp-sqk3-index", "redbsp-sqk3-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_spec_index_plot("hilltop.threepf-1.redbsp-spec-index", "redbsp-spec-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_index_plot("hilltop.threepf-1.zeta-2spec-index", "zeta-2spec-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_cost_plot("hilltop.threepf-1.sqk3-cost", "sqk3-cost.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_sigma_spec_plot("hilltop.threepf-1.sigma-spec", "sigma-spec.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_sigma_bsp_spec_plot("hilltop.threepf-1.sigma-bsp-spec", "sigma-bsp-spec.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_sigma_bsp_sqk3_plot("hilltop.threepf-1.sigma-bsp-sqk3", "sigma-bsp-sqk3.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_sigma_spec_index_plot("hilltop.threepf-1.sigma-spec-index", "sigma-spec-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_sigma_bsp_spec_index_plot("hilltop.threepf-1.sigma-bsp-spec-index", "sigma-bsp-spec-index.pdf");
    ...
    transport::output_task<double> threepf_output = transport::output_task<double>("hilltop.threepf-1.output", tk3_twopf_plot);
    ...
    std::cout << "hilltop.threepf-1 output task:" << '\n' << threepf_output << '\n';
