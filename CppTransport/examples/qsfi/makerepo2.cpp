...
//    transport::aggregation_range<double> betas = betas_lo + betas_mid + betas_hi + betas_equi;
    ...
    transport::zeta_threepf_task<double> ztk3("QSFI.threepf-1.zeta", tk3);
    ...
    transport::derived_data::time_series_plot<double> tk3_twopf_plot("QSFI.threepf-1.twopf-time", "twopf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_threepf_plot("QSFI.threepf-1.threepf-time", "threepf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_SR_objects_plot("QSFI.threepf-1.SR_objects", "SR_objects.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_Hubble_plot("QSFI.threepf-1.Hubble", "Hubble.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_u2_plot("QSFI.threepf-1.u2", "u2.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_u3_plot("QSFI.threepf-1.u3", "u3.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_zeta_twopf("QSFI.threepf-1.zeta-twopf", "zeta-twopf-time.pdf");
    ...
    transport::derived_data::time_series_plot<double> tk3_zeta_sq("QSFI.threepf-1.zeta-eq", "zeta-eq.pdf");
    tk3_zeta_sq.add_line(tk3_zeta_sq_group);
    tk3_zeta_sq.set_title_text("3pf of $\\zeta$ near equilateral configurations");

		// set up a table too
    transport::derived_data::time_series_table<double> tk3_zeta_sq_table("QSFI.threepf-1.zeta-eq.table", "zeta-eq-table.txt");
    ...
    transport::derived_data::time_series_plot<double> tk3_redbsp("QSFI.threepf-1.redbsp-eq", "redbsp-eq.pdf");
    ...
    transport::derived_data::time_series_table<double> tk3_redbsp_table = transport::derived_data::time_series_table<double>("QSFI.threepf-1.redbsp-eq.table", "redbsp-eq-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_plot("QSFI.threepf-1.zeta-2spec", "zeta-2spec.pdf");
    ...
    transport::derived_data::wavenumber_series_table<double> tk3_zeta_2spec_table("QSFI.threepf-1.zeta-2spec.table", "zeta-2spec-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_spec_plot("QSFI.threepf-1.redbsp-spec", "redbsp-spec.pdf");
    ...
    transport::derived_data::wavenumber_series_table<double> tk3_redbsp_spec_table("QSFI.threepf-1.redbsp-spec-table", "redbsp-spec-table.txt");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_spec_logplot("QSFI.threepf-1.redbsp-spec-log", "redbsp-spec-log.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_beta_plot("QSFI.threepf-1.redbsp-beta", "redbsp-beta.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_sqk3_plot("QSFI.threepf-1.redbsp-sqk3", "redbsp-sqk3.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_redbsp_sqk3_index_plot("QSFI.threepf-1.redbsp-sqk3-index", "redbsp-sqk3-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_zeta_2spec_index_plot("QSFI.threepf-1.zeta-2spec-index", "zeta-2spec-index.pdf");
    ...
    transport::derived_data::wavenumber_series_plot<double> tk3_cost_plot("QSFI.threepf-1.sqk3-cost", "sqk3-cost.pdf");
    ...
    transport::output_task<double> threepf_output = transport::output_task<double>("QSFI.threepf-1.output", tk3_twopf_plot);
    ...
    std::cout << "QSFI.threepf-1 output task:" << '\n' << threepf_output << '\n';
