...
namespace canonical
  {
    ...
    class canonical_M: public M
      ...
      public:
        ...
        //! constructor
        canonical_M(language_printer& p, expression_cache& c, resources& r, shared_resources& s,
      ...
      private:
        ...
        GiNaC::ex expr(field_index& i, field_index& j, GiNaC::ex& Vij, GiNaC::ex& Vi, GiNaC::ex& Vj,
