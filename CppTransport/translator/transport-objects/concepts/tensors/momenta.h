...
#ifndef CPPTRANSPORT_MOMENTA_H
#define CPPTRANSPORT_MOMENTA_H
...
constexpr auto MOMENTA_TENSOR_INDICES = 1;


class momenta: public transport_tensor
  {
