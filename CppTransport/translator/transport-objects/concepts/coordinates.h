...
#ifndef CPPTRANSPORT_COORDINATES_H
#define CPPTRANSPORT_COORDINATES_H
...
constexpr auto COORDINATE_TENSOR_INDICES = 1;


class coordinates: public transport_tensor
  {
...
#endif //CPPTRANSPORT_COORDINATES_H
