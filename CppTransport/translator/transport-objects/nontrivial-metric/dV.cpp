...
namespace nontrivial_metric
  {
    ...
    std::unique_ptr<flattened_tensor> nontrivial_metric_dV::compute(const index_literal_list& indices)
      {
    ...
    unroll_behaviour nontrivial_metric_dV::get_unroll()
      {
    ...
    std::unique_ptr<atomic_lambda> nontrivial_metric_dV::compute_lambda(const index_literal& i)
      {
    ...
    nontrivial_metric_dV::nontrivial_metric_dV(language_printer& p, cse& cw, resources& r, shared_resources& s, index_flatten& f)
      : dV(),
        printer(p),
        cse_worker(cw),
        res(r),
    ...
    void nontrivial_metric_dV::pre_explicit(const index_literal_list& indices)
      {
      }


    void nontrivial_metric_dV::post()
      {
      }
