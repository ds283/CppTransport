...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_U1_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_U1_H
...
namespace nontrivial_metric
  {
    ...
    class nontrivial_metric_u1 : public ::u1
      {
      ...
      public:
        ...
        //! constructor
        nontrivial_metric_u1(language_printer& p, cse& cw, expression_cache& c, resources& r, shared_resources& s,
                     boost::timer::cpu_timer& tm, index_flatten& f, index_traits& t);

        //! destructor is default
        virtual ~nontrivial_metric_u1() = default;
      ...
      public:
        ...
        GiNaC::ex compute_component(phase_index i) override;
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_U1_H
