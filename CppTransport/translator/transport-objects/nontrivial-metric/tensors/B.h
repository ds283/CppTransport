...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_B_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_B_H
...
namespace nontrivial_metric
  {
    ...
    class B : public ::B
      ...
      public:
        ...
        //! constructor
        B(language_printer& p, cse& cw, expression_cache& c, resources& r, shared_resources& s,
      ...
      private:
        ...
        expr(const GiNaC::ex& delta_ik, const GiNaC::ex& delta_jk, const GiNaC::ex& Vi, const GiNaC::ex& Vj,
             ...
             const GiNaC::ex& deriv_k, const symbol_wrapper& k1, const symbol_wrapper& k2, const symbol_wrapper& k3,
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_B_H
