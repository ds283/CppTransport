...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_MOMENTA_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_MOMENTA_H


#include <memory>

#include "concepts/tensors/momenta.h"
...
namespace nontrivial_metric
  {
    ...
    class momenta : public ::momenta
      ...
      public:
        ...
        //! constructor
        momenta(language_printer& p, cse& cw, resources& r, shared_resources& s,
                index_flatten& f, index_traits& t);
        
        //! destructor is default
        virtual ~momenta() = default;
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_MOMENTA_H
