...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_ZETA2_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_ZETA2_H
...
namespace nontrivial_metric
  {
    ...
    class zeta2 : public ::zeta2
      ...
      public:
        ...
        //! constructor
        zeta2(language_printer& p, cse& cw, expression_cache& c, resources& r, shared_resources& s,
      ...
      public:
        ...
        compute(const index_literal_list& indices, symbol_wrapper& k, symbol_wrapper& k1, symbol_wrapper& k2,
                symbol_wrapper& a) override;

        //! evaluate component of tensor
        GiNaC::ex
        compute_component(phase_index i, phase_index j,
                          symbol_wrapper& k, symbol_wrapper& k1, symbol_wrapper& k2, symbol_wrapper& a) override;
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_ZETA2_H
