...
namespace nontrivial_metric
  {
    ...
    Riemann_A3::Riemann_A3(language_printer& p, cse& cw, expression_cache& c,
    ...
    GiNaC::ex Riemann_A3::compute_component(field_index i, field_index j, field_index k)
      {
        return GiNaC::ex();
      }
    ...
    unroll_behaviour Riemann_A3::get_unroll(const index_literal_list& idx_list)
      {
        if(res.can_roll_Riemann_A3(idx_list)) return unroll_behaviour::allow;
