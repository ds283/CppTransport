...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_CONNEXION_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_CONNEXION_H


#include <memory>

#include "concepts/tensors/connexion.h"
...
namespace nontrivial_metric
  {
    ...
    class connexion : public ::connexion
      ...
      public:
        ...
        //! constructor
        connexion(language_printer& p, cse& cw, resources& r, shared_resources& s, index_flatten& f);
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_CONNEXION_H
