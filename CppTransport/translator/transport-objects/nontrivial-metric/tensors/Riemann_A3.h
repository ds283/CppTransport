...
#include "concepts/tensors/Riemann_A3.h"
...
namespace nontrivial_metric
  {
    ...
    class Riemann_A3 : public ::Riemann_A3
      {
      ...
      public:
        ...
        //! constructor
        Riemann_A3(language_printer& p, cse& cw, expression_cache& c, resources& r, shared_resources& s,
