...
namespace nontrivial_metric
  {
    ...
    GiNaC::ex B::compute_component(field_index i, field_index j, field_index k,
                                   GiNaC::symbol& k1, GiNaC::symbol& k2, GiNaC::symbol& k3, GiNaC::symbol& a)
      {
        ...
        auto args = this->res.generate_cache_arguments<field_index>(use_dV | use_Riemann_B3, { i, j, k }, this->printer);
        args += { k1, k2, k3, a };
        ...
        if(!this->cache.query(expression_item_types::B_item, index, args, result))
          {
            ...
            result = this->expr(delta_ik, delta_jk, Vi, Vj, Vk, B3_ijk, deriv_i, deriv_j, deriv_k, k1, k2, k3, a);
    ...
    GiNaC::ex B::expr(const GiNaC::ex& delta_ik, const GiNaC::ex& delta_jk, const GiNaC::ex& Vi, const GiNaC::ex& Vj,
                      const GiNaC::ex& Vk, const GiNaC::ex& B3_ijk, const GiNaC::ex& deriv_i, const GiNaC::ex& deriv_j,
                      const GiNaC::ex& deriv_k, const GiNaC::symbol& k1, const GiNaC::symbol& k2,
    ...
    unroll_state B::get_unroll(const index_literal_list& idx_list)
      {
        ...
        const std::array<variance, RESOURCE_INDICES::RIEMANN_B3_INDICES> ijk = { idx_list[0]->get_variance(),
                                                                                 idx_list[1]->get_variance(),
                                                                                 idx_list[2]->get_variance() };
    ...
    B::compute_lambda(const index_literal& i, const index_literal& j, const index_literal& k,
                      GiNaC::symbol& k1, GiNaC::symbol& k2, GiNaC::symbol& k3, GiNaC::symbol& a)
      {
        ...
        auto args = this->res.generate_cache_arguments<index_literal>(use_dV | use_Riemann_B3, { i, j, k }, this->printer);
        args += { k1, k2, k3, a };
        args += { idx_i, idx_j, idx_k };
    ...
    B::B(language_printer& p, cse& cw, expression_cache& c, resources& r, shared_resources& s,
      ...
      : ::B(),
        ...
        B3([&](auto k) -> auto { return res.Riemann_B3_resource(k[0], k[1], k[2], printer); }),
        G(r, s, f, p)
      {
