...
namespace nontrivial_metric
  {
    ...
    GiNaC::ex C::compute_component(field_index i, field_index j, field_index k,
                                   symbol_wrapper& k1, symbol_wrapper& k2, symbol_wrapper& k3, symbol_wrapper& a)
      {
        ...
        auto args = this->res.generate_cache_arguments(0, std::array<field_index, 3>{i,j,k}, this->printer);
        args += { k1, k2, k3, a };
    ...
    C::expr(const GiNaC::ex& delta_ij, const GiNaC::ex& delta_jk, const GiNaC::ex& delta_ik, const GiNaC::ex& deriv_i,
            const GiNaC::ex& deriv_j, const GiNaC::ex& deriv_k, const symbol_wrapper& k1, const symbol_wrapper& k2,
    ...
    C::compute_lambda(const index_literal& i, const index_literal& j, const index_literal& k,
                      symbol_wrapper& k1, symbol_wrapper& k2, symbol_wrapper& k3, symbol_wrapper& a)
      {
        ...
        auto args =
          this->res.generate_cache_arguments(0, std::array<index_literal, 3>{i,j,k}, this->printer);
        args += { k1, k2, k3, a };
        args += { idx_i, idx_j, idx_k };
