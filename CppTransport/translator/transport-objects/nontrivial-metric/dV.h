...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_DV_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_DV_H
...
namespace nontrivial_metric
  {
    ...
    class nontrivial_metric_dV : public ::dV
      {
      ...
      public:
        ...
        //! constructor
        nontrivial_metric_dV(language_printer& p, cse& cw, resources& r, shared_resources& s, index_flatten& f);

        //! destructor is default
        virtual ~nontrivial_metric_dV() = default;
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_DV_H
