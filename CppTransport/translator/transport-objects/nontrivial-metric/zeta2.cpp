...
namespace nontrivial_metric
  {
    ...
    nontrivial_metric_zeta2::compute(const index_literal_list& indices, GiNaC::symbol& k, GiNaC::symbol& k1, GiNaC::symbol& k2,
                             GiNaC::symbol& a)
      {
    ...
    GiNaC::ex nontrivial_metric_zeta2::compute_component(phase_index i, phase_index j,
    ...
    void nontrivial_metric_zeta2::pre_explicit(const index_literal_list& indices)
      {
    ...
    void nontrivial_metric_zeta2::pre_lambda()
      {
    ...
    void nontrivial_metric_zeta2::post()
      {
    ...
    GiNaC::ex nontrivial_metric_zeta2::expr_field_field(GiNaC::ex& deriv_i, GiNaC::ex& deriv_j,
                                                GiNaC::symbol& k, GiNaC::symbol& k1, GiNaC::symbol& k2,
                                                GiNaC::symbol& a)
      {
        // formulae from DS calculation 28 May 2014
    ...
    GiNaC::ex nontrivial_metric_zeta2::expr_field_momentum(GiNaC::idx& i, GiNaC::idx& j, GiNaC::ex& deriv_i, GiNaC::ex& deriv_j,
                                                   GiNaC::symbol& k, GiNaC::symbol& k1, GiNaC::symbol& k2,
                                                   GiNaC::symbol& a)
      {
        // formulae from DS calculation 28 May 2014
    ...
    unroll_behaviour nontrivial_metric_zeta2::get_unroll()
      {
    ...
    nontrivial_metric_zeta2::compute_lambda(const index_literal& i, const index_literal& j, GiNaC::symbol& k,
    ...
    nontrivial_metric_zeta2::nontrivial_metric_zeta2(language_printer& p, cse& cw, expression_cache& c, resources& r,
