...
#ifndef CPPTRANSPORT_NONTRIVIAL_METRIC_DN1_H
#define CPPTRANSPORT_NONTRIVIAL_METRIC_DN1_H
...
namespace nontrivial_metric
  {
    ...
    class nontrivial_metric_dN1 : public ::dN1
      ...
      public:
        ...
        //! constructor
        nontrivial_metric_dN1(language_printer& p, cse& cw, expression_cache& c, resources& r, shared_resources& s,
                      boost::timer::cpu_timer& tm, index_flatten& f, index_traits& t);

        //! destructor is default
        virtual ~nontrivial_metric_dN1() = default;
...
#endif //CPPTRANSPORT_NONTRIVIAL_METRIC_DN1_H
