...
namespace nontrivial_metric
  {
    ...
    nontrivial_metric_u3::compute(const index_literal_list& indices, GiNaC::symbol& k1, GiNaC::symbol& k2, GiNaC::symbol& k3,
                          GiNaC::symbol& a)
      {
    ...
    GiNaC::ex nontrivial_metric_u3::compute_component(phase_index i, phase_index j, phase_index k,
    ...
    unroll_behaviour nontrivial_metric_u3::get_unroll()
      {
    ...
    nontrivial_metric_u3::compute_lambda(const index_literal& i, const index_literal& j, const index_literal& k,
                                 GiNaC::symbol& k1, GiNaC::symbol& k2, GiNaC::symbol& k3, GiNaC::symbol& a)
      {
    ...
    void nontrivial_metric_u3::pre_explicit(const index_literal_list& indices)
      {
    ...
    void nontrivial_metric_u3::post()
      {
