...
#define __dtwopf_si(A,B)   __dxdt[$MODEL_pool::twopf_si_start + FLATTEN(A,B)]
        ...
        __dtwopf_si($A, $B) $=  + $U2_CONTAINER[AC] * __twopf_si($C, $B);
        __dtwopf_si($A, $B) $+= + $U2_CONTAINER[BC] * __twopf_si($A, $C);
...
#define __dthreepf(A,B,C)       __dxdt[$MODEL_pool::threepf_start        + FLATTEN(A,B,C)]
        ...
        __dtwopf_si_re_k2($A, $B) $=  + $U2_k2_CONTAINER[AC] * __twopf_si_re_k2($C, $B);
        __dtwopf_si_re_k2($A, $B) $+= + $U2_k2_CONTAINER[BC] * __twopf_si_re_k2($A, $C);
        ...
        __dtwopf_si_re_k3($A, $B) $=  + $U2_k3_CONTAINER[AC] * __twopf_si_re_k3($C, $B);
        __dtwopf_si_re_k3($A, $B) $+= + $U2_k3_CONTAINER[BC] * __twopf_si_re_k3($A, $C);
