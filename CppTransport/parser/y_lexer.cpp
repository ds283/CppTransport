...
enum y::y_parser::token::yytokentype keyword_tokens[] =
  {
      ...
      y::y_parser::token::implementation,
      y::y_parser::token::model,
      y::y_parser::token::abserr,
      y::y_parser::token::relerr,
      y::y_parser::token::stepper,
      y::y_parser::token::stepsize,
      y::y_parser::token::background,
      y::y_parser::token::perturbations,
      y::y_parser::token::indexorder,
      y::y_parser::token::left,
      y::y_parser::token::right,
...
enum y::y_parser::token::yytokentype symbol_tokens[] =
  {
      ...
      y::y_parser::token::equals,
      y::y_parser::token::plus,
      y::y_parser::token::binary_minus,
      y::y_parser::token::unary_minus,
